...
<html lang="en">
  ...
  <body>
    ...
    <p>
      2021 16" M1 MacBook Pro, purchased in my last semester of college in spring of 2022; Used often for reading and coding remotely. Wallpaper:    </p>
    ...
    <ul>
      ...
      <li>Editor: <a>NeoVim</a> or VS Code</li>
      <li>Browser: Firefox. plugins:<ul style='padding-left: 20px'>
        <li>Vimium</li>
        <li>uBlock Origin</li>
        <li>Dark Reader</li>
        <li>Sidebery</li>
