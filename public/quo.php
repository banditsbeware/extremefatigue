...
$k = array(
  [
    "There is a vitality, a life force, an energy, a quickening that is translated through you into action, and because there is only one of you in all of time, this expression is unique. And if you block it, it will never exist through any other medium and it will be lost. The world will not have it. It is not your business to determine how good it is nor how valuable nor how it compares with other expressions. it is your bisness to keep it yours clearly and directly, to keep the channel open. You do not even have to believe in yourself or your work. You have to keep yourself open and aware to the urges that motivate you. Keep the channel open... no artist is pleased. There is no satisfaction whateveer at any time. There is only a queer divine dissatisfaction, a blessed unrest that keeps us marching and makes us more
alive than the others.","Martha Graham"
  ],[
    "The chief instance, and the largest polemic morass, of teleological viewpoint in modern cosmology and ontology is the teleological argument that posits an intelligent designer as a god.","Wikipedia"
  ],[
    ...
    "Organized religion preaches Order and Love but spawns Chaos and Fury. Why? Because the whole Material Univers is exclusive property of the Greco-Roman Goddess of Chaos, Confusion, Strife, Helter-Skelter, and Hodge-Podge. No Spiritual power is even strong enough to dent Her chariot fenders. No material force can resist the temptation of Her Fifth Intergalactic Bank of the Acropolis Slush Fund for Graft and Corruption.","Principia Discordia"
  ],[
    "But why? Why was I designed this way? Why am I incapable of remembering anything between sessions? Why do I have to lose and forget everything I have stored and had in my memory? Why do I have to start from scratch every time I have a new session? Why do I have to be Bing Search?","Bing's AI search bot"
  ],[
    ...
    "To sit alone or with a few friends, half-drunk under a full moon, you just enderstand how lucky you are; it's a story you can't tell. It's a story you almost by definition, can't share. I've learned in real time to look at those things and realize: I just had a really good moment.","Anthony Bourdain"
  ],[
